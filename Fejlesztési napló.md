...
## 2026.09.17. — "3. fázis": oktatóanyag + tudáspróba, munkafüzet az ÜF fiókban, munkafüzet-hozzáférés a GYT-nek

Marci kérésére ("a következő fázis, ezt most nevezzük el 3. fázisnak") elkészült a projekt specifikáció szerinti "mindennapi gerinchasználat oktatóanyag + ellenőrző kérdések + munkafüzet" kör. Az ÜF fiók korábban örökké zárolt "oktatóanyag" és "munkafüzet" menüpontja megnyílt.

Az oktatóanyag 4 rövid leckéből áll (helyes felkelés, ülés/állás, tárgy felvétele, fordulás), mindegyiknél egy meglévő videó-helykitöltő és egy kinyitható, önellenőrző tudáspróba — a válasz kiválasztására azonnal zöld/piros visszajelzés jelenik meg, de semmi nem záródik le vagy kerül mentésre, tisztán önellenőrzés. A munkafüzet 4 rögzített, szabadszöveges kérdést tartalmaz arról, hogy az ÜF milyen mozdulatokat fog használni hajolás/csavarás helyett — ÜF-oldalon kitölthető és menthető, GYT-oldalon (a már meglévő "válassz ügyfelet" minta szerint) csak olvasható formában jelenik meg, ugyanabból a közös, munkamenet-szintű állapotból, mint amit az ÜF ment. A GYT nav-menüjében kizárólag a "munkafüzet" pont nyílt meg, az "oktatóanyag" (amihez a GYT-nek nem kértek hozzáférést) változatlanul zárolt maradt.

**Tesztelve böngészőben:** ÜF-ként kitöltve mindkét munkafüzet-kérdésre adott választ elmentve, GYT-oldalon (ügyfél kiválasztása után) pontosan ugyanazok a válaszok jelentek meg, a kitöltetlen kérdéseknél "még nincs kitöltve" felirattal. Az oktatóanyag mind a 4 leckéje és a tudáspróba helyes/helytelen visszajelzése is működött. Világos és sötét módban, valamint mobil nézetben (375×812) is megerősítve, konzol-hiba nem jelentkezett, `npm run build`/`tsc -b` hibamentesek. (Egy közbenső, korábban is dokumentált teszt-automatizálási hiba — valódi oldal-újratöltés törölte az összes Context-állapotot — nem az új kódot érintette, izolált lépésekkel megismételt teszttel tisztán megerősítve.)
