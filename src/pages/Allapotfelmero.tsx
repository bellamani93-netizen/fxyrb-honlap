...
// `intensityColor`/`intensityGlow`/`useDarkMode` a `src/utils/intensityColor.ts`
// közös modulból jön (2026.09.24., 172. pont: a checklist "tünet napi
// intenzitása" csúszkája is ugyanezt a színskálát vette át — ld. a modul
// tetején lévő jegyzetet a színskála teljes indoklásáért).
