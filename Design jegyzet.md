...
\- Folyamat-lépések (.process-flow / .process-step / .process-arrow — Fázis 1-ben új): számozott vagy ikonos lépés-kártyák, köztük tükrözött chevron-nyíllal — konverziós tölcsér vagy módszertani lépéssor bemutatására. Mobilon függőlegesre esik szét, a nyíl 90°-ban elfordul. **Belső elrendezés (2026.08.25., pontosítva ugyaneznap):** a kör hátterű ikon-jelvény (.process-step-icon-badge) a kártya TETEJÉN, teljes szélességben, középen áll — ez alatt egy sor: bal oldalt egy nagy, halvány (45% opacitás) sorszám (.process-step-number), jobb oldalt a cím+leírás. A szám **SVG `<text>`-ként** rajzolódik (`preserveAspectRatio="none"`), így ténylegesen — nem csak vizuálisan nagy betűmérettel — a cím tetejétől a leírás aljáig nyúlik, kártyánként a tényleges szöveghosszhoz igazodva.  
