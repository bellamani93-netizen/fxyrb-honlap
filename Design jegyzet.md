...
\- Folyamat-lépések (.process-flow / .process-step / .process-arrow — Fázis 1-ben új): számozott vagy ikonos lépés-kártyák, köztük tükrözött chevron-nyíllal — konverziós tölcsér vagy módszertani lépéssor bemutatására. Mobilon függőlegesre esik szét, a nyíl 90°-ban elfordul. **Belső elrendezés (2026.08.25., új):** kártyánként bal oldalt nagy, halvány (45% opacitás) sorszám (.process-step-number), jobb oldalt középre igazított tartalom — kör hátterű ikon-jelvény (.process-step-icon-badge) a cím fölött, alatta a leírás.  
...
\- Hírlevél/regisztrációs panel (.newsletter): sötét (navy) kártya, cím \+ leírás \+ form (e-mail, illetve szükség esetén név \+ e-mail) \+ mikroszöveg. **Ikon-jelvény (.newsletter-icon-badge, 2026.08.25., új):** nagy (8rem), halvány mint-árnyalatú körbe helyezett ikon a panel szöveg-oszlopa mellett (jobb oldalon) — ez a mintázat máshol is használható, ahol egy nagyobb, dekoratív ikon-illusztráció kell egy szöveges blokk mellé.  
